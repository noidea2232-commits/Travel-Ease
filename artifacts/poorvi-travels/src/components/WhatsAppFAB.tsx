export default function WhatsAppFAB() {
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col gap-3 items-center">
      ...
      {/* WhatsApp Button */}
      <a
        href="https://wa.me/919902727466?text=Hi! I want to book a cab with Poorvi Best Travels."
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center w-[56px] h-[56px] rounded-full bg-[#25D366] hover:bg-[#20bf5a] text-white shadow-2xl shadow-[#25D366]/30 transition-all hover:scale-105 active:scale-95"
        aria-label="Chat with Poorvi Best Travels on WhatsApp"
        data-testid="whatsapp-fab"
        title="WhatsApp: 099027 27466"
      >
